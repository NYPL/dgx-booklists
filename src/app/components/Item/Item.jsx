  ...
  */
  handleClick(e) {
    ...
    axios
      ...
      .then(response => {
        this.context.router.push(`/browse/recommendations/lists/${this.props.userId}/${this.props.listId}`);
      });
  },
  ...
  render() {
    ...
    return (
      <div id={this.props.id} className={this.props.className}>
        ...
        <div className={`${this.props.className}__image-wrapper`} onClick={this.handleClick}>
          {bookCovers}
        </div>
      </div>
    );
