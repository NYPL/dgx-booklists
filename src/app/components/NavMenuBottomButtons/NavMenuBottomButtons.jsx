    ...
    return (
      <div className={this.props.className} style={styles.base}>
        <a href={this.props.libraryCardLink} className={libraryCardClass}
          style={styles.links} onClick={gaUtils._trackHeader.bind(this, 'Click', 'Mobile Bottom Buttons - Library Card')}>
        ...
        <a href={this.props.subscribeLink} className={subscribeLinkClass}
          style={styles.links} onClick={gaUtils._trackHeader.bind(this, 'Click', 'Mobile Bottom Buttons - Email Updates')}>
